...
#define INSTALL_SYSFS_ENTRY	"/sys/devices/soc0/kim/install"
#define DEV_NAME_SYSFS		"/sys/devices/soc0/kim/dev_name"
#define BAUD_RATE_SYSFS		"/sys/devices/soc0/kim/baud_rate"
#define FLOW_CTRL_SYSFS		"/sys/devices/soc0/kim/flow_cntrl"
